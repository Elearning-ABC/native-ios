...
struct TestEndView: View {
    ...
    var body: some View {
        if let testProgressApp = testViewModel.getTestProgressApp(testInfoId: testInfo.id, testLevel: testLevel){
            ...
            VStack {
                ...
                ScrollView{
                    ForEach(testInfo.testQuestionData){ testDataItem in
                        ...
                        let correct = testViewModel.getCorectNumberInTopic(testDataItem: testDataItem)
                        
                        let name = testViewModel.getNameInTopic(topicId: testDataItem.topicId)
...
struct PracticeEndView_Previews: PreviewProvider {
    static var previews: some View {
        TestEndView(testInfo: TestInfo(), testLevel: .easy, title: "")
    }
}
